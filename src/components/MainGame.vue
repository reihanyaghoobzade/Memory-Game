...
const timer = computed(() => {
  info.minutes =
    info.minutes < 10 ? ("0" + info.minutes).slice(-2) : info.minutes;
  info.seconds =
    info.seconds < 10 ? ("0" + info.seconds).slice(-2) : info.seconds;
